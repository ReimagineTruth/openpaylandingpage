...
const HREF: Record<string, string> = {
  ...
  openusd: `${APP}/openusd`,
  send: `${APP}/auth/send`,
  "send-pi-hub": `${APP}/send`,
  "send-pi": `${APP}/send/pi`,
  request: `${APP}/auth/request-payment`,
  invoice: `${APP}/auth/send-invoice`,
  scan: `${APP}/scan-qr`,
  "scan-help": `${APP}/scan-qr`,
  "scan-pi": `${APP}/scan-qr?returnTo=/send/pi`,
  "pi-thankyou": `${APP}/send/pi`,
  "pi-activity": `${APP}/auth/activity`,
  "pi-receipt": `${APP}/send/pi`,
  "pi-notifications": `${APP}/auth/notifications`,
  "pi-setup": `${APP}/send/pi`,
  qrpay: `${APP}/qr-pay`,
...
export const FEATURE_BULLETS = [
  ...
  { label: "Send & Receive", detail: "OpenPay, Pro, or Pi Wallet" },
